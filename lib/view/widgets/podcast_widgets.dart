...
class PodcastEmpty extends StatelessWidget {
  const PodcastEmpty({super.key, required this.textTheme});
...
class PlayerManager extends StatelessWidget {
  const PlayerManager({super.key, required this.controller});
...
class Titlee extends StatelessWidget {
  const Titlee({super.key, required this.podcastModel, required this.textheme});
...
class FileList extends StatelessWidget {
  const FileList({super.key, required this.controller, required this.textheme});
...
class Writer extends StatelessWidget {
  const Writer({super.key, required this.podcastModel, required this.textheme});
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(podcastModel.publisher!, style: textheme.headlineMedium),
          SizedBox(width: Dimens.medium),
        ],
      ),
    );
